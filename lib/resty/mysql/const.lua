...
_M.CAPABILITY_MAP = CAPABILITY_MAP

_M.DEFAULT_CAPABILITY = bor(
    CAPABILITY_MAP.CLIENT_LONG_PASSWORD, CAPABILITY_MAP.CLIENT_LONG_FLAG,
    CAPABILITY_MAP.CLIENT_CONNECT_WITH_DB, CAPABILITY_MAP.CLIENT_PROTOCOL_41,
    CAPABILITY_MAP.CLIENT_TRANSACTIONS, CAPABILITY_MAP.CLIENT_SECURE_CONNECTION
)

_M.MIN_PROTOCOL_VERISON     = 10
_M.SERVER_VERISON           = "5.6.20-myproxy"
_M.DEFAULT_CHARSET          = "utf8"
_M.DEFAULT_COLLATION_ID     = 33
_M.DEFAULT_COLLATION_NAME   = "utf8_general_ci"
_M.BASE_CONN_ID             = 10000
_M.MAX_PACKET_SIZE          = 1024 * 1024
_M.OK_HEADER                = 0x00
_M.ERR_HEADER               = 0xff
_M.EOF_HEADER               = 0xfe
_M.DATA_HEADER_UPPER        = 250
_M.DEFAULT_MYSQL_STATE      = "HY000"
_M.DEFAULT_MYSQL_ERRMESSAGE = "mysql error"
